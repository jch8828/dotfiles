...
keymap.set("n", "<leader>wq", ":wq<CR>", default_opts) -- save and quit
keymap.set("n", "<leader>qq", ":q!<CR>", default_opts) -- quit without saving
keymap.set("n", "<leader>ww", ":w<CR>", default_opts) -- save

-- Cancel search highlighting with ESC
keymap.set("n", "<Space><Space>", ":nohlsearch<Bar>:echo<CR>", default_opts)
